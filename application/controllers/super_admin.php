...
class Super_admin extends CI_Controller {
    ...
    function new_request_details() {
        $data['main_content'] = 'superadminpages/new_request_details';
        $this->load->view('includes/template', $data);
    }   
    function ajax_new_request_data() {   
        ...
        $data['search_datas'] = $this->request_model->get_super_admin_new_request_data($target_number,$request_by,$crime_type,$start_date,$end_date);    
        $this->load->view('superadminpages/ajax_new_request_page',$data);
    }    
    function ajax_new_request_transaction_details() {    
        ...
        $this->load->view('superadminpages/ajax_new_request_id_wise_details',$data);
    }
    function pending_request_details() {
        $data['main_content'] = 'superadminpages/pending_request_details';
        $this->load->view('includes/template', $data);
    }
     function ajax_pending_request_data() {         
        ...
        $this->load->view('superadminpages/ajax_pending_request_page',$data);
    }
    function ajax_pending_transaction_details() {    
        $transaction_id =$this->input->post('transaction_id');           
        $data['search_datas'] = $this->request_model->get_id_wise_request_data($transaction_id);    
        $this->load->view('superadminpages/ajax_pending_request_id_wise_details',$data);
    }
    function completed_request_details() {
     ...
     function ajax_completed_request_data() {         
        ...
        $this->load->view('superadminpages/ajax_completed_request_page',$data);
    }
    function ajax_completed_transaction_details() {    
        ...
        //var_dump($data['search_datas']);die;
        $this->load->view('superadminpages/ajax_completed_request_id_wise_details',$data);
    }    
    ...
    function ajax_special_request_data() {   
        ...
        $this->load->view('superadminpages/ajax_special_request_page',$data);
    }    
