...
class SuperRequestProvider extends CI_Controller {
    ...
    public function SuperRequestProviderDashboard(){
        $data['main_content'] = 'SuperRequestProvider/superRequestProviderDashboard';
        $this->load->view('includes/template', $data);
		
    }
	
    function new_request_details() {
        $data['main_content'] = 'SuperRequestProvider/new_request_details';
        $this->load->view('includes/template', $data);
    }   

    function view_request_details() {
        $data['main_content'] = 'SuperRequestProvider/view_request_details';
        $this->load->view('includes/template', $data);
    }
    ...
    function ajax_new_request_data(){
        ...
        $this->load->view('SuperRequestProvider/ajax_new_request_page',$data);
    }    
    ...
    function ajax_new_request_transaction_details() {    
		...
		// die;
        $this->load->view('SuperRequestProvider/ajax_new_request_id_wise_details',$data);
    }
	
    function pending_request_details() {
        $data['main_content'] = 'SuperRequestProvider/pending_request_details';
        $this->load->view('includes/template', $data);
    }
...
/*############     For Document File ###################*/
 ...
 /* ###############  End Document ##########  */   
    ...
    function ajax_pending_request_data() {         
        ...
        //var_dump($data['search_datas']);die;
        $this->load->view('SuperRequestProvider/ajax_pending_request_page',$data);
    }
    ...
    function ajax_pending_transaction_details() {    
		...
		$data['search_datas']['requiredInfo'] = $dataArray;
        $this->load->view('SuperRequestProvider/ajax_pending_request_id_wise_details',$data);
    }
    function completed_request_details() {
        $data['main_content'] = 'SuperRequestProvider/completed_request_details';
        $this->load->view('includes/template', $data);
    }
     function ajax_completed_request_data() {         
        ...
        //var_dump($data['search_datas']);die;
        $this->load->view('SuperRequestProvider/ajax_completed_request_page',$data);
    }
    function ajax_completed_transaction_details() {    
        ...
        //var_dump($data['search_datas']);die;
        $this->load->view('SuperRequestProvider/ajax_completed_request_id_wise_details',$data);
    }
