                                    ...
                                    <tr>
                                        ...
                                        <td align="center">          
                                            <a data-remote="false" data-toggle="modal" data-target="#myModal2" class="btn btn-xs btn-info"
                                                id="edit_info" data-function_id="<?= $user_type['battalions_id'];?>" title="Edit">
                                                <i class="fa fa-pencil-square-o"></i> 
                                            </a>                                             
                                            <a class="btn btn-danger btn-xs delete_user_type" data-toggle="tooltip" onclick="return confirm('Are you sure you want to delete this item?');" data-user_type_id="<?= $user_type['battalions_id'];?>" data-original-title="Delete">
