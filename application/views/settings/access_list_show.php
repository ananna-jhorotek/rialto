            ...
            <table id="example" class=" data-table table table-striped table-bordered"  width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php $menus=$this->settings_model->get_menu_role($role['roleid']);?>
                                        ...
                                        <td>
                                            <?php $functions=$this->settings_model->get_function_role($role['roleid']);?>
    ...
    $(document).ready(function () {
     ...
     $('body').on('click', '#edit_info', function () {
         var role_id = $(this).data('role_id');
          var url = '<?= site_url('settings/ajax_menu_role_edit'); ?>';
            $.ajax({
                    type : "post",
