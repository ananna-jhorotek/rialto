                    ...
                    <table id="example" class=" data-table table table-striped table-bordered"  width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?= $search_data['users_name'].' - '.$search_data['designation'].' - '.$search_data['battalion']; ?></td> 
                                <td align="center"><?= $search_data['crime_name'] ?>  </td>      
                                <td align="center"><?= $search_data['date_requested'] ?>  </td> 
                                <td align="center"><?= $search_data['usersname'] ?>  </td>      
                                <td align="center"><?= $search_data['completed_date'] ?>  </td> 
                                <td align="center"> 
