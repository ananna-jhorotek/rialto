                            ...
                            <div class="table-responsive"> 
                                <table id="example" class=" data-table table table-striped table-bordered"  width="100%" cellspacing="0">
                                    ...
                                    <?php $default_datas = $this->db
                                                                ...
                                                                ->where('tbl_req_mno_msisdn.request_status', 'Completed')                                                                
                                                                ->where('tbl_req_mno_msisdn.completed_by', $this->session->userdata('user_id'))
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Completed Request Information</h4>
                </div>
...
$(document).ready(function(){           
        ...
        $.ajax({
            ...
            dataType: 'html',
            async: false,
            url: "<?= site_url('SuperRequestProvider/ajax_completed_request_data'); ?>",
    ...
    $('body').on('click', '#details_page', function () {
        //alert('ok');
         var transaction_id = $(this).data('transaction_id');
          var url = '<?= site_url('SuperRequestProvider/ajax_completed_transaction_details'); ?>';
            $.ajax({
                    type : "post",
