                                    ...
                                    <?php $default_data2 = $this->db
                                      ...
                                      <?php $i=1; foreach($default_datas as $default_data):?>
                                            <tr>
                                                ...
                                                <td align="center"><?= $default_data['name'].' - '.$default_data['designation'].' - '.$default_data['battalion']; ?></td> 
...
$(document).ready(function(){           
    ...
    $('body').on('click','#search_button',function(){
         ...
         var end_date = $('#end_date').val();   
            ...
            $.ajax({
                ...
                dataType: 'html',
                async: false,
                url: "<?= site_url('SuperRequestProvider/ajax_new_request_data'); ?>",
	...
	//alert('ok');
	 var transaction_id = $(this).data('transaction_id');
	  var url = '<?= site_url('SuperRequestProvider/ajax_new_request_transaction_details'); ?>';
		$.ajax({
				type : "post",
