        ...
        <div class="col-lg-12 col-xs-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">                   
                    ...
                    <label for="txtFloor"><span class="errorStar"></span> Completed By :</label> &nbsp;&nbsp;
                    <span class="errorStar"><?= $search_datas['usersname']; ?></span> <br>   
                    <label for="txtFloor"><span class="errorStar"></span> Completed Date :</label> &nbsp;&nbsp;
                    <span class="errorStar"><?= $search_datas['completed_date']; ?></span> <br>   
                </div>
            </div>
        </div>  
    </div>  
