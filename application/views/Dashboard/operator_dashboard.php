...
<!--                <ol class="breadcrumb">
        ...
        <div class="col-lg-4 col-xs-4">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?= site_url('request/new_request_details'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-4">
        ...
        <div class="col-lg-4 col-xs-4">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php $completed_request_number = $this->db->where('request_status','completed')->get('tbl_req_mno_msisdn')->num_rows();?>
