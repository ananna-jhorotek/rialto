            ...
            <div class="row">
                <div class="col-lg-3 col-xs-3">
                    ...
                    <div class="small-box bg-blue-active">
                        ...
                        <a href="<?= site_url('admin_request/new_request_details'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-3">
                    ...
                    <div class="small-box bg-red-active">
                      ...
                      <a href="<?= site_url('admin_request/pending_request_details'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-3">
                    ...
                    <div class="small-box bg-aqua-active">
                        ...
                        <a href="<?= site_url('admin_request/completed_request_details'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-3">
...
//                                                ->where('date_requested', date('Y-m-d'))                                                
                        ...
                        <a href="<?= site_url('admin_request/special_request_details'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
